  ...
  var e = "config",
    ...
    It = {
      ...
      extend: function (e, t) {
        ...
        It[n](t, function (n) {
          It[F](t[n])
            ? (It[F](e[n]) || (e[n] = []), It[M](e[n], t[n]))
            : typeof t[n] == E
            ? (typeof e[n] != E && (e[n] = {}), It[M](e[n], t[n]))
            : (e[n] = t[n]);
        });
      },
      ...
      unlock: function () {
        (It[x] = d),
          (document.cookie =
            ...
            (It[e].domainLock ? "/" : window[I].pathname)),
      ...
      changeState: function (l) {
        ...
        if (!It[S][ot][It[s]]) {
          (It[S][ot][It[s]] = { config: {}, elements: [], values: {} }),
            (g = It[S][ot][It[s]]),
          ...
          It[n](h, function (s) {
            It[t][h[s]][e][yt] &&
              ((k = "ss" + h[s]),
              (x = It[i](k)) ||
                (x = It[f](k, It.newStyleSheet(It[t][h[s]][e][yt]), N, 5)),
              g[r][U](x)),
              It[t][h[s]][r][c] > 0 &&
        ...
        It.detachAllElements(g[r]),
          ...
          It[q](function () {
            var t,
              r,
              i,
              s = It.getLevel(g[e].grid[Bt]);
            It[e].RTL && (It.unreverseRows(), s > 0 && It.reverseRows(s)),
              It[w][it] > 8 &&
                ((r = "_skel_cell_important_placeholder"),
      ...
      newInline: function (e) {
        ...
        return (
          It[w][it] <= 8
            ? ((t = document[k]("span")),
              (t[kt] = '&nbsp;<style type="text/css">' + e + "</style>"))
            : ((t = document[k]("style")), (t.type = Lt), (t[kt] = e)),
          t
        );
      },
      newDiv: function (e) {
      ...
      initConfig: function (i) {
        ...
        var s = [],
          o = [];
        typeof i == E && (i[t] && (It[e][t] = {}), It[M](It[e], i)),
